    	    ...
    	    <div class="col-11 col-sm-7">
    		   ...
    		   <form action="/editclan" method="POST" enctype="multipart/form-data">
    			  ...
    			  <div class="form-group">
    				 ...
    				 <textarea id="summernote" class="form-control" rows="3" name="description">{!!$clan->description!!}</textarea>
    				 <small class="form-test text-muted">The description of the Clan goes here.</small>
    			  </div>
    			  <div class="form-group">
    				 <label for="image-upload">Clan Image</label>
    				 <img class="mb-3" src="../images/{{$clan->picture}}" style="height: 100px; width: auto; display: block;" />
    				 <input type="file" class="form-control-file" id="image" name="image">
    				 <small class="form-test text-muted">Please choose an image that is 16:9 in ratio. Larger is better. Max File Size: 1MB.</small>
				  </div>
				  <div class="alert alert-secondary" role="alert">
               ...
               <button class="btn btn-danger btn-lg my-2" data-toggle="modal" data-target="#clanDeleteModal">Delete This Clan</button>
    	    </div>
    	</div>
</div>

<div class="modal fade" id="clanDeleteModal" tabindex="-1" role="dialog" aria-labelledby="clanDeleteModal" aria-hidden="true">
